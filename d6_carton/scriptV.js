...
var indexhtml_suivant='index.html';
...
var dialogue_liste=[ // contient la liste des dialogues [le dialogue1[ligne de dialogue, l'index du nom(pseudo_list) de celui qui parle], le dialogue2 ...]
  [
    ['Parfait !', 1],
    ['Prenez soin de vous et notre porte est toujours ouverte si besoin est.', 2],
    ['Elle vous prend tous les deux dans ses bras, retenant ses larmes. Avant de vous laisser partir en direction de votre nouveau chez-vous', 0],
  ...
  //// JOSEPH ligne pour toi en dessous
 // !!!!!! La scène se termine en fermant les portes du camion (bruitage) et la transition s’opère avec l’ouverture des portes d’un placard/tiroir dans le bureau de travail.
